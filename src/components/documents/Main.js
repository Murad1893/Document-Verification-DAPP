      ...
      <div className='container'>
        <div className='row align-center'>
          <div className='col-12'>
            <h2 className="custom-verify-h2"> Documents </h2>
            <h3 className="custom-verify-h3"><span className='doc-count'> Count: {this.state.count.total}</span> </h3>
          </div>
        </div>
        ...
        {this.state.isRequester && (
          <div>
            <div className='float-right'>
               <button type="button" className="btn btn-primary btn-block" onClick={this.createScreen}>Create</button>
            </div>
