    ...
    return (
      <div className='container'>
        ...
        <div className='row  justify-content-md-center'>
          <div className='col-3'>
            <button type='button' className='btn btn-primary btn-block' onClick={this.verify}>Verify</button>
          </div>
        </div>
